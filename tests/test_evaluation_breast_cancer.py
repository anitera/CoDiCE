...
class TestCFSearch(unittest.TestCase):
    def setUp(self):
        # Example usage:
        self.test_identifier = 'breast_cancer_proto'
    ...
    def test_evaluation(self):
        ...
        df_original_instances = pd.read_csv('results/df_origin_input_breast_cancer_proto.csv')
        df_counterfactuals = pd.read_csv('results/df_origin_cf_breast_cancer_proto.csv')
