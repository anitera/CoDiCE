...
class TestCFSearch(unittest.TestCase):
    ...
    def test_cf_search_for_train(self):
        ...
        self._x_train.to_csv("results/original_homeloan_train.csv", index=False)
        all_counterfactuals.to_csv("results/counterfactuals_homeloan_train_weighted.csv", index=False)    
